...
<path fill-rule="evenodd" clip-rule="evenodd" d="M5.46484 3.92349C4.79896 3.5739 4 4.05683 4 4.80888V19.1911C4 19.9432 4.79896 20.4261 5.46483 20.0765L19.1622 12.8854C19.8758 12.5108 19.8758 11.4892 19.1622 11.1146L5.46484 3.92349ZM2 4.80888C2 2.55271 4.3969 1.10395 6.39451 2.15269L20.0919 9.34382C22.2326 10.4677 22.2325 13.5324 20.0919 14.6562L6.3945 21.8473C4.39689 22.8961 2 21.4473 2 19.1911V4.80888Z" fill="#394B56"/>
            ...
            <div id="open_sidebar" style={{ display: sidebarStatus === "open_sidebar" ? 'block' : 'none' }} >
              ...
              <div id="journey_fields" style={{ display: activeSidebarOption === "journey_planner" ? 'none' : 'block' }}>
              ...
              <div id="saved_routes">
                ...
                <svg id="sidebar-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
  <path d="M479.761-139.826q-16.152 0-32.446-5.837-16.293-5.837-28.967-18.272l-69.479-63.478q-105.521-96.283-191.26-192.62Q71.869-516.37 71.869-634q0-97.576 65.153-162.973 65.152-65.397 162.739-65.397 52.522 0 99.282 21.424 46.761 21.424 80.718 59.467 33.956-38.043 80.717-59.467 46.761-21.424 99.283-21.424 97.678 0 163.143 65.397Q888.37-731.576 888.37-634q0 117.63-85.598 214.467-85.598 96.837-193.12 193.359l-68.239 62.478q-12.674 12.435-29.087 18.153-16.413 5.717-32.565 5.717Zm-39.674-548.978q-27.565-39.566-60.924-61.066-33.359-21.5-79.337-21.5-58.696 0-97.826 39.164-39.13 39.163-39.13 98.206 0 51.541 36.64 109.524 36.641 57.983 87.64 112.497 51 54.514 104.971 102.09 53.97 47.576 87.64 78.302 33.761-31 87.83-78.554 54.07-47.554 105.163-102.044 51.094-54.489 87.855-112.272Q797.37-582.239 797.37-634q0-59.043-39.284-98.206-39.284-39.164-98.21-39.164-46.159 0-79.398 21.5t-60.804 61.066q-7.31 10.717-17.753 16.076-10.443 5.358-22.16 5.358-11.718 0-22.072-5.358-10.354-5.359-17.602-16.076ZM480-501.478Z" fill="#394B56"/>
</svg>

<div id="sidebar-button" ><button onClick={() => toggleSidebarOptionTab("destinations")}>
                    Saved Destinations
                  </button></div>
                </div>

                <div id="destination_list" style={{ display: activeSidebarOption === "destinations" ? 'block' : 'none' }}>
                  <SavedRoutes
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M5.46484 3.92349C4.79896 3.5739 4 4.05683 4 4.80888V19.1911C4 19.9432 4.79896 20.4261 5.46483 20.0765L19.1622 12.8854C19.8758 12.5108 19.8758 11.4892 19.1622 11.1146L5.46484 3.92349ZM2 4.80888C2 2.55271 4.3969 1.10395 6.39451 2.15269L20.0919 9.34382C22.2326 10.4677 22.2325 13.5324 20.0919 14.6562L6.3945 21.8473C4.39689 22.8961 2 21.4473 2 19.1911V4.80888Z" fill="#394B56"/>
</svg>            <div id="sidebar-button" ><button onClick={() => toggleSidebarOptionTab("saved_list")}>
                      Saved Links
                    </button></div>
                  </div>

                  <div id="saved_list" style={{ display: activeSidebarOption === "saved_list" ? 'block' : 'none' }}>
                    <SavedLinks />
                  </div>
                </div>
                </div>
              ...
              <a href="./contact" id="contact_us">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M798.478-111.869q-126.458 0-249.881-55.098T323.739-323.38Q222.304-424.696 167.206-548.198 112.109-671.7 112.109-798.239q0-21.382 14.186-35.637 14.186-14.255 35.466-14.255h161.761q19.5 0 33.369 11.533 13.87 11.533 17.305 29.555l25.761 134.978q2.956 19.587-.881 33.217-3.837 13.631-14.706 23.783l-98.435 96.087q19.043 34.369 45.109 66.956 26.065 32.587 58.108 63.631 29.805 29.804 61.413 54.63 31.609 24.826 66.261 44.913l95.674-94.957q11.63-11.391 28.522-16.369 16.891-4.978 34.478-2.022l131.543 27.283q19.022 5.434 30.055 18.445 11.033 13.011 11.033 31.033v163.674q0 21.382-14.272 35.637-14.272 14.255-35.381 14.255ZM242.435-603.826l65.761-63.848-16.522-89.456h-87.326q4.522 39.326 13.153 77.638 8.631 38.312 24.934 75.666ZM601.391-244.63q37.566 16.282 76.75 26.043 39.185 9.761 78.989 13.239v-86.804l-89.217-18.522-66.522 66.044ZM242.435-603.826ZM601.391-244.63Z" fill="#394B56"/></svg>
                <div id="sidebar-button" ><button>Contact Us</button></div>
              </a>
              ...
              <a href="./feedback" id="feedback">
                ...
                <div id="sidebar-button" ><button>Feedback</button></div>
              </a>
                </div>
                </div>
            </div>
