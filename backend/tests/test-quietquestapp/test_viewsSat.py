...
from quietquestapp.models import NoiseLocations, TaxiWeekendLocations
...
def test_directions_view():
    ...
    for hour in range(0, 23):
        ...
        taxi_locations_objects.append(TaxiWeekendLocations(long=-73.994052, lat=40.743439, hour=hour, count=0))
        taxi_locations_objects.append(TaxiWeekendLocations(long=-73.99675563, lat=40.74457668, hour=hour, count=4))
        taxi_locations_objects.append(TaxiWeekendLocations(long=-73.99675563, lat=40.74457668, hour=hour, count=4))
